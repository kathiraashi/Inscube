...
export class CaptureViewComponent implements OnInit {
  ...
  constructor(public snackBar: MatSnackBar,
              ...
              this.Capture_Id = this.active_route.snapshot.params['Capture_Id'];
                this.Capture_Service.Cube_Capture_View(this.LoginUser._id, this.Capture_Id).subscribe( datas => {
                  this.Loader_1 = false;
     ...
     this.modalRef.content.onClose.subscribe(result => {
        ...
        this.Capture_Service.Cube_Capture_Delete(this.Trigger_PostInfo._id).subscribe( datas => {
           if (datas['Status'] === 'True' && datas['Output'] === 'True') {
              ...
              this.route.navigate(['/Cube_Posts']);
           }
        });
        }
     });
