...
@Component({
  ...
  styleUrls: ['./feeds-view.component.css']
})
  ...
  constructor(public snackBar: MatSnackBar,
    ...
    private active_route: ActivatedRoute,
              ...
              this.active_route.url.subscribe((u) => {
                this.Post_Id = this.active_route.snapshot.params['Post_Id'];
                this.Post_Service.Cube_Post_View(this.LoginUser._id, this.Post_Id).subscribe( datas => {
                  this.Loader_1 = false;
