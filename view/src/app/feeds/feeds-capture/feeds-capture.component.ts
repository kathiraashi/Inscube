...
@Component({
   selector: 'app-feeds-capture',
   templateUrl: './feeds-capture.component.html',
   styleUrls: ['./feeds-capture.component.css']
})
export class FeedsCaptureComponent implements OnInit {
   ...
   constructor(public snackBar: MatSnackBar,
               ...
               this.Capture_Service.Cube_Capture_List(this.LoginUser._id, 0).subscribe( datas => {
                  this.Loader_1 = false;
                  this.Skip_Count =  15;
                     if (datas['Status'] === 'True') {
                        ...
                        if ( this.Capture_List.length < 15) {
