...
@Component({
  selector: 'app-report-trends-comment',
  templateUrl: './report-trends-comment.component.html',
  styleUrls: ['./report-trends-comment.component.css']
})
export class ReportTrendsCommentComponent implements OnInit {
  ...
  submit(value) {
    if (this.ActiveText === 'Other' && value === '') {
      ...
      this._Service.Report_TrendsComment(this.data.Values)
        .subscribe( datas => {
