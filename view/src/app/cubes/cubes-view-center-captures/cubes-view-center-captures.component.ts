...
@Component({
  selector: 'app-cubes-view-center-captures',
  templateUrl: './cubes-view-center-captures.component.html',
  styleUrls: ['./cubes-view-center-captures.component.css']
})
export class CubesViewCenterCapturesComponent implements OnInit {
  ...
  constructor(public snackBar: MatSnackBar,
              ...
              this.Capture_Service.Cube_Based_Capture_List(this.Cube_Id, this.LoginUser._id).subscribe( datas => {
                 this.Loader_1 = false;
